    ...
    >
      <div className="justify-between px-4 lg:px-32 mx-auto lg:max-w-7xl md:items-center md:flex md:px-8  bg-transparent ">
        <div>
          <div className="flex items-center justify-between py-3 md:py-5 md:block ">
            <a draggable="false" href="#hero" className="flex justify-center items-stretch gap-4">
              ...
              />
              <h2 className="font-bold text-sky-50 text-base leading-4 lg:text-xl lg:leading-6  font-comfortaa ">
                Alan<br />Fernandes
              </h2>
            </a>
        ...
        <div>
          ...
          >
            <ul className="items-center font-bold justify-center space-y-8 md:flex md:space-x-6 text-center md:space-y-0 bg-transparent font-comfortaa">

function ProjectCard({ title, description, link }) {
  return (
    <div class="relative flex flex-col justify-center overflow-hidden font-archivo gap-4">
      <div class="mb-4 group relative cursor-pointer overflow-hidden bg-gradient-to-tl from-extendcolor01-0 to-neutral-900 px-6 pt-10 rounded-lg  shadow-xl ring-1 ring-gray-900/5 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl sm:mx-auto sm:max-w-sm  sm:px-10 pb-6">
